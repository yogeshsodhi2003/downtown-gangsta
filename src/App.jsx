...
function App() {
  ...
  useGSAP(() => {
    ...
    // Set initial transform origin for Firefox compatibility
    gsap.set(".dtg-logo", {
      svgOrigin: "400 300",
      transformOrigin: "center center"
    });

    // Set initial state for last page heading
    gsap.set(".last-page-heading", {
      scale: 0,
      opacity: 0,
      y: 100
    });

    // Add last page animation to the main timeline
    tl.set("#dtg-text-d", {
      opacity: 1,
      duration: 1,
      delay: 0.5,
    ...
    // Add ScrollTrigger for last page heading
  ...
  return (
    <>
      ...
      {showContent && (
        <div className='main bg-black h-full w-full rotate-[-19deg] scale-[1.5] overflow-hidden'>
          <div className='landing h-screen w-full relative overflow-hidden'>
            <img className='sky absolute top-0 left-0 object-cover w-full h-full scale-[1.2] rotate-[-30deg]' src="./sky.png" alt="" />
            <img className='bg absolute top-0 left-0 object-cover w-full h-full scale-[1.2]' src="./bg.png" alt="" />
            
            <h1 className='main-text absolute top-[20%] left-[40%] text-white scale-[4]'>DOWNTOWN</h1>
            <h1 className='main-text absolute top-[30%] left-[50%] text-white scale-[4]'>GANGSTA</h1>
          
            <img className='character absolute bottom-[-20%] left-[40%] object-cover scale-[1.2] rotate-[-35deg]' src="./character.png" alt="" />
            <div className='btmbar absolute bottom-0 w-full py-15 px-10 bg-gradient-to-t from-black to-transparent'>
              ...
              <img className='absolute bottom-[5%] right-[2%] h-[60%]' src="./ps5.png" alt="" />
            </div>
          </div>
        </div>
      )}
      ...
      <div className='last-page animation relative w-full h-screen bg-black'>
        <h1 className='last-page-heading text-white text-9xl absolute top-[30%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 font-bold'>COMING SOON</h1>
      </div>
